...
class ProxyResponsesAdapterTests(unittest.TestCase):
    ...
    def test_encodes_reasoning_and_content_events(self) -> None:
        ...
        self.assertEqual(finished[0]["type"], "response.reasoning_text.done")
        self.assertEqual(finished[1]["type"], "response.output_item.done")
        self.assertEqual(finished[2]["type"], "response.output_text.done")
        self.assertEqual(finished[3]["type"], "response.output_item.done")
    ...
    def test_encodes_tool_call_stream_events(self) -> None:
        ...
        self.assertEqual(payload[1]["type"], "response.function_call_arguments.delta")
        self.assertEqual(payload[1]["item_id"], "fc_fixed")
        self.assertEqual(payload[2]["type"], "response.function_call_arguments.done")
        self.assertEqual(payload[2]["item_id"], "fc_fixed")
        self.assertEqual(payload[3]["type"], "response.output_item.done")
